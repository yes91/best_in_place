...
function BestInPlaceEditor(e, container) {
    'use strict';
    this.element = e;
    ...
    jQuery(this.container).on('click', this.activator, {editor: this}, this.clickHandler);
}
...
BestInPlaceEditor.prototype = {
    ...
    activate: function () {
        ...
        jQuery(this.container).off('click', this.activator, this.clickHandler);
        this.activateForm();
...
jQuery.fn.best_in_place = function (container, activator) {
    'use strict';
    function setBestInPlace(element) {
        if (!element.data('bestInPlaceEditor')) {
            element.data('bestInPlaceEditor', new BestInPlaceEditor(element, container));
            return true;
        }
    }

    jQuery(container).on('click', this.selector, function () {
        var el = jQuery(this);
    ...
    jQuery(container).on('click', activator, function () {
        var el = jQuery(activator);
        if (setBestInPlace(el)) {
            el.click();
        }
    });
